...
public class Mahasiswa21 extends Mahasiswa{
    Mahasiswa21(String nim, String nama, int nilai){
        super(nim, nama, nilai);
    }
    
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        ArrayList<Mahasiswa21> daftar = new ArrayList<>();
        ...
        for (int i = 0; i < tot_data; i++) {
            ...
            System.out.println("===============================");
            Mahasiswa21 Jumlah = new Mahasiswa21(nim, nama, nilai);
            daftar.add(Jumlah);
            if (Jumlah.isLulus()) {
                tot_lulus++;
                nm_lulus += nama + ", ";
            ...
            if (Jumlah.getGradeGG() == 'A') {
                nil_a++;
                nm_a += nama + ", ";
            } else if (Jumlah.getGradeGG() == 'B') {
                nil_b++;
                nm_b += nama + ", ";
            } else if (Jumlah.getGradeGG() == 'C') {
                nil_c++;
                nm_c += nama + ", ";
            } else if (Jumlah.getGradeGG() == 'D') {
                nil_d++;
                nm_d += nama + ", ";
            } else if (Jumlah.getGradeGG() == 'E') {
                nil_e++;
                nm_e += nama + ", ";
            }
            tot_nilai += nilai;
